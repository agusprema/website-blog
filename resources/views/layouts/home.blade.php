...
<body id="body" class="font-sans antialiased bg-light dark:bg-dark" data-theme="{{ MyWebsite::theme() }}">
    ...
    <div class="min-h-screen" id="app">
        ...
        <main class="mb-4">
            <x-homes.highlight />
            <x-homes.ads-highlight />
            <div class="container mx-auto grid grid-cols-12 gap-2 lg:gap-4 px-2 xl:px-0">
                <div class="col-span-12 lg:col-span-9">
                    {{ $slot }}

                    <x-homes.mini-content />
                </div>
                <div class="col-span-12 lg:col-span-3">
                    <div class="grid grid-cols-2 gap-1">
                        <x-homes.tranding-topic title="Server Error 1" />
                        <x-homes.ads-sidebar />
                        <x-homes.tranding-topic title="Server Error 2" />
                        <x-homes.ads-sidebar />
                        <x-homes.tranding-topic title="Server Error 3" />
                        <x-homes.ads-sidebar />
                        <x-homes.tranding-topic title="Server Error 4" />
                        <x-homes.ads-sidebar />
                    </div>
                </div>
            </div>
