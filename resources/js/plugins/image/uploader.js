...
export default class Uploader {
     ...
     */
    constructor({ config, onUpload, onError, onSetDataBrowser }) {
        this.config = config;
        this.onUpload = onUpload;
        this.onError = onError;
        this.onSetDataBrowser = onSetDataBrowser;
    }
    ...
    uploadSelectedFile({ onPreview }) {
        ...
        if (
            ...
            console.log(upload);
            console.log(this.config.endpoints.byFile);
        }
    ...
    fileBrowser({ onPreview }) {
        var options = {
            prefix: "/laravel-filemanager",
            type: "image",
        };
        var onSetDataBrowser = this.onSetDataBrowser;
