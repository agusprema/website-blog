...
window.livewire.directive("sortable-group", function (el, directive, component) {
  ...
  var options = {
    ...
    plugins: [_shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Plugins.ResizeMirror, _shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Plugins.SortAnimation, _shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Plugins.SwapAnimation]
  };
  ...
  var sortable = el.livewire_sortable = new _shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Sortable([], options);
...
window.livewire.directive("sortable", function (el, directive, component) {
  ...
  var sortable = new _shopify_draggable__WEBPACK_IMPORTED_MODULE_0__.Sortable(el, options);
  sortable.on("sortable:stop", function () {
    setTimeout(function () {
      var items = [];
